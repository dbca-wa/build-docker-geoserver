...
ARG CORS_EXPOSED_HEADERS=Access-Control-Allow-Origin,Access-Control-Allow-Credentials, Authorization
ARG CORS_SUPPORT_CREDENTIALS=false
...
ENV CORS_EXPOSED_HEADERS=$CORS_EXPOSED_HEADERS
ENV CORS_SUPPORT_CREDENTIALS=$CORS_SUPPORT_CREDENTIALS
